  ...
  return (
    <div className={styles.signUpContainer}>
      ...
      <div className={styles.signUpWelcome}>
        ...
        <Image alt='Grafos em formato de olho' src={Graphs1} className={styles.signUpCircles}></Image>
        <Image alt='Grafos em formato de olho' src={Graphs2} className={styles.signUpCirclesBottom}></Image>
        ...
        <form className={styles.signUpFormBox}>
          ...
          <div className={styles.signUpRow}>
            ...
            <div className={styles.signUpInputGroup}>
              ...
              <select id="genero" defaultValue="" className={` ${styles.signUpInput} ${styles.signUpSelect}`}>
          ...
          <div className={styles.signUpRow}>
            <div className={styles.signUpInputGroup}>
              ...
              <input id="rg" type="text" placeholder="190.203.400-14" />
            </div>
